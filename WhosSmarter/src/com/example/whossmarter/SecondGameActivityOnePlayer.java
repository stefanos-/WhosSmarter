...
public  class SecondGameActivityOnePlayer extends Activity implements OnClickListener{
	...
	public static TextView questTV, tv2 , score1, player01;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SecondGameActivityOnePlayer.context = getApplicationContext();
		
		StopThread = false;
		
		MainActivity.numberOfPlayers = 1;
		...
		player01  = (TextView)findViewById(R.id.TextView01);
	...
	public class RequestTask extends AsyncTask<String, String, String>{
	    ...
	    protected void onPostExecute(String result) {
	        ...
	        if(result != null){
	        	...
	        	StopThread = true;
	            System.exit(0);
	            Toast.makeText(SecondGameActivityOnePlayer.this, "Problem with question downloading",Toast.LENGTH_SHORT).show();
	        }
	    }
	}
    ...
    public void onClick(View v) {
		if(ButtonAlreadyPressedA == false){
	        		...
	        		handler.postDelayed(new Runnable() {
	        		  ...
	        		  public void run() {
		        		  ...
		        		  if(counter<MainActivity.numberOfQuestions){	  
		        			  ...
		        			  Intent localIntent = new Intent(SecondGameActivityOnePlayer.this, finalScore.class);
		        			  Bundle b = new Bundle();
		        			  b.putInt("key", score_A);
    ...
    public class MyCounter extends CountDownTimer{
        ...
        public void onFinish() {
            ...
            if(MainActivity.locallyStoredQuest == true){
            	...
            	progressDialog = new ProgressDialog(SecondGameActivityOnePlayer.this);
		    	...
		    	if(progressValue>=100){
			        ...
			        if(counter<MainActivity.numberOfQuestions){	  
				        ...
				        printAnswer();
	        			  ...
	        			  Intent localIntent = new Intent(SecondGameActivityOnePlayer.context, finalScore.class);
	        			  localIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
	        			  Bundle b = new Bundle();
	        			  b.putInt("key", score_A);
	        			  localIntent.putExtras(b);
	        			  SecondGameActivityOnePlayer.context.startActivity(localIntent);
	      		          System.exit(0);
	        		  }
		    	}
	    	}
